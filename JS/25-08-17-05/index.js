...
function LogTime(target) {
    return /** @class */ (function (_super) {
        ...
        function class_1() {
            ...
            _this.createdTime = new Date();
            return _this;
        }
        class_1.prototype.getTime = function () {
            return "\u521B\u5EFA\u65F6\u95F4\uFF1A".concat(this.createdTime);
        };
        return class_1;
    }(target));
}
var Person = function () {
    var _classDecorators = [LogTime];
    ...
    var Person = _classThis = /** @class */ (function () {
        ...
        Person_1.prototype.speak = function () {
            console.log('你好呀！');
        };
        return Person_1;
    }());
